...
@section('title', ($item->id ? 'Editar' : 'Nuevo') . ' Tema')

@section('content')
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('tema_list') }}">Temas</a></li>
            <li class="breadcrumb-item active">{{ $item->id ? 'Editar' : 'Nuevo' }}</li>
        </ol>
    </nav>
    <h1>{{ $item->id ? 'Editar' : 'Nuevo' }} Tema</h1>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ $item->id ? route('tema_update', $item) : route('tema_store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('tema_list') }}" class="btn btn-outline-secondary">Cancelar</a>
