...
@section('title', ($item->id ? 'Editar' : 'Nueva') . ' Etiqueta')

@section('content')
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('etiqueta_list') }}">Etiquetas</a></li>
            <li class="breadcrumb-item active">{{ $item->id ? 'Editar' : 'Nueva' }}</li>
        </ol>
    </nav>
    <h1>{{ $item->id ? 'Editar' : 'Nueva' }} Etiqueta</h1>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ $item->id ? route('etiqueta_update', $item) : route('etiqueta_store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('etiqueta_list') }}" class="btn btn-outline-secondary">Cancelar</a>
